...
export function AiFloatingWindow({ open, onClose, messages, busy, onSend, onClear, enabled, model, activeSymbol }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-h-0">
        {enabled ? (
          <AiChatPanel messages={messages} busy={busy} onSend={onSend} activeSymbol={activeSymbol} compact />
        ) : (
